...
Check out [FRONTEND LIVE DEMO](https://hunger-captain-frontend.meljuetten7.repl.co/) here!!

Check out [API LIVE DEMO](https://huger-captain-backend.meljuetten7.repl.co) here!!
...
1. Git Clone (https://github.com/Meljuetten7/hunger-captain.git)
